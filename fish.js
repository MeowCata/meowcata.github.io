...
var RENDERER = {
	...
	setParameters: function() {
		...
		this.$container = document.getElementById('fish');
	...
	render: function() {
		...
		if (htmlBody.style.backgroundColor === 'black') {
			this.context.fillStyle = 'rgb(128, 157, 236)';
		} else {
			this.context.fillStyle = 'rgb(152, 206, 255)';
		}
		//this.context.fillStyle = 'rgb(55, 199, 255)';
		for (var i = 0, count = this.fishes.length; i < count; i++) {
